...
public class ChartService
{
    public static AvaPlot UpdateNetworthPlot(AvaPlot plot, List<List<Networth>> networthTrends)
    {
        ...
        var totalNetworth = plot.Plot.Add.ScatterLine(GenerateCoordinates(networthTrends[0]));
    ...
    {
        var coordinates = new Coordinates[networthTrend.Count];
    ...
    private static AvaPlot SetupDateTimeAxisFormat(AvaPlot plot)
    {
        ...
        {
            var isMidnight = dt is { Hour: 0, Minute: 0, Second: 0 };
            return isMidnight
        ...
        var tickGen = (DateTimeAutomatic)axis.TickGenerator;
